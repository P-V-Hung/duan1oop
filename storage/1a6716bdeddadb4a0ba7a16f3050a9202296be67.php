    ...
    <form action="/savethanhtoan" id="formThanhToan" method="post">
        <div class="location border p-3">
            ...
            <div class="location_ship d-flex">
                <b> <small class="textFullname"><?php echo e($_SESSION['user']['fullname']); ?></small> (+<small class="textTel"><?php echo e($_SESSION['user']['tel']); ?></small>)</b>
                <p class="ms-5 textAddress"><?php echo e($_SESSION['user']['address']); ?></p>
            ...
            <div class="voucher_bong d-flex justify-content-center align-items-center">
                <div class="voucher_content border p-4">
                    ...
                    <div class="voucher_content-main py-4 px-4 border my-4">
                        <input class="border my-2 py-2" type="text" value="<?php echo e($_SESSION['user']['fullname']); ?>" name="fullname" placeholder="Họ và tên người nhận" id="fullname"><br>
                        <input class="border my-2 py-2" type="text" value="<?php echo e($_SESSION['user']['tel']); ?>" name="tel" placeholder="Số điện thoại" id="tel"><br>
                        <td class="api-tinh">
                            <select class="form-select" id="tinh">
                                <?php if(isset($fromAddress[3]) && !empty($fromAddress[3])): ?>
                                <option value=""><?php echo e($fromAddress[3]); ?></option>
                                <?php else: ?>
                                <option value="">Chọn tỉnh thành</option>
                                <?php endif; ?>
                            </select>
                            <select class="form-select my-1" id="huyen">
                                <?php if(isset($fromAddress[2]) && !empty($fromAddress[2])): ?>
                                <option value=""><?php echo e($fromAddress[2]); ?></option>
                                <?php else: ?>
                                <option value="">Chọn quận huyện</option>
                                <?php endif; ?>
                            </select>
                            <select class="form-select" id="xa">
                                <?php if(isset($fromAddress[1]) && !empty($fromAddress[1])): ?>
                                <option value=""><?php echo e($fromAddress[1]); ?></option>
                                <?php else: ?>
                        ...
                        <input class="border my-2 py-2" type="text" value="<?php echo e($address); ?>" placeholder="Địa chỉ" name="address" id="address"><br>
                    </div>
        ...
        <div class="listcart border mt-4 pt-3 ">
            ...
            <hr>
            <!-- Danh sách -->
            <?php $__currentLoopData = $listData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="cart_total d-flex justify-content-end">
                <table>
                    <tr>
                        ...
                        <td class="p-2 ps-5 d-flex justify-content-end"> <span class="total_pro"><?php echo e(number_format($total)); ?></span> vnđ </td>
                    </tr>
                    <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\duan1-oop\resources\views\client/thanhtoan/thanhtoan.blade.php ENDPATH**/ ?>