...
<div class="signUp changePass">
    ...
    <form action="/changepass" id="formChangePass" method="post">
        <input type="hidden" name="iduser" value="<?php echo e($id); ?>">
        <div>
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\duan1-oop\resources\views\client/user/newPass.blade.php ENDPATH**/ ?>