...
<input type="hidden" id="idpro" value="<?php echo e($product['id']); ?>">
...
<div class="box-product-right-content new-product">
    <?php $__currentLoopData = $listProperty; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="card card-edit" style="width: 17rem">
        <img src="../public/uploads/<?php echo e($product['pro_img']); ?>" class="card-img-top" alt="ảnh sản phẩm" />
        <div class="card-body">
            <h5 class="card-title product-title-name-all"><?php echo e($product['pro_name']); ?></h5>
            <p class="card-text">Giá: <?php echo e(number_format($property['pp_price'])); ?></p>
            <div class="card-views d-flex justify-content-between">
                <span>Lượt mua : <?php echo e($property['pp_buys']); ?></span>
                <span>Tồn kho : <?php echo e($property['pp_count']); ?></span>
            </div>
            <div class="card-views d-flex justify-content-between">
                <span>Màu: <?php echo e($property['pp_color']); ?></span>
                <span>Size: <?php echo e($property['pp_size']); ?></span>
            </div>
            <div class="card-thaotac mt-2 d-flex justify-content-center align-items-center">
                <button data-id="<?php echo e($property['id']); ?>" class="btn btn-outline-primary me-3 edit-property">Cập nhật</button>
                <button data-id="<?php echo e($property['id']); ?>" class="btn btn-outline-danger del-property">Xóa</button>
            </div>
        </div>
    </div>
...
</script><?php /**PATH C:\Users\ADMIN\Desktop\duan1-oop\resources\views\admin/product/info.blade.php ENDPATH**/ ?>