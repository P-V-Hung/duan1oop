...
<div class="container-xxl">
    <div class="collections row mt-5 px-5">
        <div class="col-7 collections-img">
            <div class="">
                <img src="../public/uploads/{{$product['img']}}" alt="" id="ImgAnh" class="width:100%;">
                <div class="border img-child-client filtering">
                    <div class="img-con">
                        <img src="../public/uploads/{{$product['img']}}" class="imgChildToggel" style="width: 100%;height: auto;" alt="">
                    </div>
                    @foreach($listImg as $img)
                    <div class="img-con">
                        <img src="../public/uploads/{{$img['img']}}" class="imgChildToggel" style="width: 100%;height: auto;" alt="">
                    </div>
                    @endforeach
        ...
        <div class="col-5 collections-product">
            <div class="collections-product-show">
                <div class="title">
                    ...
                    <span class="price">Giá : {{$product['min_price']. " - " . $product['max_price']." VNĐ"}}</span>
                </div>
                <p>Đã bán : <span class="daban" style="font-weight: bold;">{{$product['buys']}}</span></p>
                <div class="cate">
                    <div class="cate-color">
                        <p>Màu sắc: </p>
                        <div class="boxColor">
                            @foreach($colors as $color)
                            <button data-color="{{$color['pp_color']}}" class="px-2 btn btn-outline-dark btn_color">{{$color['pp_color']}}</button>
                            @endforeach
                        </div>
                    </div>
                    <div class="cate-size">
                        ...
                        <div class="boxSize">
                            ...
                            <button data-size="{{$size['pp_size']}}" class="px-2 btn btn-outline-dark btn_size">{{$size['pp_size']}}</button>
                            @endforeach
                        </div>
                    </div>
                    <form action="/muangay" id="addtocart" class="form_count my-3" method="post">
                        <div class="cate-count">
                            <p>Số lượng : <b class="soluongsanpham">{{$product['count']}}</b></p>
                            <div class="rangee">
                                <div class="field">
                                    <div class=" value left">
                                        1
                                    </div>
                                    <input type="number" name="count" class="span-input-count" min="1" max="{{$product['count']}}" value="1" steps="1">
                        ...
                        <input type="hidden" id="idpro" name="idpro" value="{{$product['id']}}">
