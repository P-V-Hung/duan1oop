        ...
        <form action="/saveeditinfo" method="post" enctype="multipart/form-data">
            ...
            <div class="box-userInfo-content-left">
                <table class="table">
                    <tr>
                        ...
                        <td><input type="text" id="user" name="u_username" value="{{$user['username']}}" readonly></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td><input type="text" id="email" name="u_email" value="{{$user['email']}}" readonly></td>
                    </tr>
                    <tr>
                        <td>Họ và tên</td>
                        <td><input type="text" id="fullname" name="u_fullname" value="{{$user['fullname']}}"></td>
                    </tr>
                    <tr>
                        <td>Số điện thoại</td>
                        <td><input type="text" id="tel" name="u_tel" value="{{$user['tel']}}"></td>
                    </tr>
                    <tr>
                        <td>Địa chỉ</td>
                        <td class="api-tinh">
                            <select class="form-select" id="tinh">
                                ...
                                <input type="hidden" id="inputTinh" value="{{$address[3]}}" name="tinh">
                                @else
                            ...
                            <select class="form-select my-1" id="huyen">
                                ...
                                <input type="hidden" id="inputHuyen" value="{{$address[2]}}" name="huyen">
                                @else
                            ...
                            <select class="form-select" id="xa">
                                ...
                                <input type="hidden" id="inputXa" value="{{$address[1]}}" name="xa">
                                @else
                    ...
                    <tr>
                        <td>Chi tiết</td>
                        <td><input placeholder="Địa chỉ chi tiết" type="text" id="address" name="u_address" value="{{$user['address']}}"></td>
                    </tr>
                </table>
            ...
            <div class="box-userInfo-content-right">
                <div class="box-userInfo-content-right-img">
                    <img src="./public/uploads/{{$user['img']}}" alt="" id="userInfo-avatar" />
