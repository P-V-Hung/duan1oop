...
<form id="form-edit-pro">
    ...
    <div class="collections row mt-5 px-5 justify-content-evenly">
        <div class="col-5 collections-img">
            <div>
                <img id="img-add-pro" src="../public/uploads/{{$product['pro_img']}}" alt="" style="width:100%;">
            </div>
            <div class="my-3">
            ...
            <div class="img-slider">
                ...
                <div class="img-item del px-1">
                    <div data-id="{{$img['id']}}" class="imgdel">
                        <i class="fa-solid fa-trash"></i>
                    </div>
                    <img src="../public/uploads/{{$img['img']}}" alt="">
                </div>
                @endforeach
            </div>
            <div class="comment">
                <div class="comment-title">
                    <h5>Mô tả: </h5>
                    <textarea name="pro_desc" id="text-mota" class="border" rows="10">{{$product['pro_desc']}}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="collections-product-show">
                <div class="title">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập tên sản phẩm" value="{{$product['pro_name']}}" require name="pro_name" id="basic-url" aria-describedby="basic-addon3">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon3">Giá gốc</span>
                        <input type="text" class="form-control" placeholder="Giá gốc sản phẩm" value="{{$product['del_price']}}" name="del_price" id="basic-url" aria-describedby="basic-addon3">
                    </div>
                ...
                <div class="cate">
                    ...
                    <div class="input-group mt-3">
                        ...
                        <select class="form-select" name="pro_status" id="inputGroupSelect01">
                            ...
                            <option value="1" {{$product['pro_status']==1?'selected':''}}>Ngừng bán</option>
                        </select>
                    </div>
